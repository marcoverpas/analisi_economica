...
I flussi di un periodo sono registrati nella **matrice delle transazioni**, che ha la struttura seguente (un segno *più* indica una fonte o un'entrata, un segno *meno* un impiego o un'uscita. Il conto delle imprese è sdoppiato in conto *corrente* e conto *capitale*):
