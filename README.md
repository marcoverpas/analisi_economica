...
1. **Produzione.** All'inizio del ciclo la classe produttiva impiega le proprie *anticipazioni* (sementi, strumenti e i salari anticipati ai lavoratori) e lavora la terra. Al termine dell'annata ottiene il prodotto lordo, cioè il raccolto. Poiché per i fisiocratici solo l'agricoltura rende più di quanto consuma, in quel prodotto è contenuta un'eccedenza sui costi: il *produit net*. Nel frattempo la classe sterile ha trasformato materie prime in manufatti, senza però generare alcuna eccedenza (il valore dei suoi prodotti eguaglia quello degli input impiegati).

2. **Distribuzione del sovrappiù.** La classe produttiva versa il *produit net* ai proprietari terrieri sotto forma di **rendita**: è la freccia che, nella figura, va dall'agricoltura al riquadro dorato. Poniamo che valga 2 miliardi. Ora sono i proprietari ad avere in mano il denaro, mentre le due classi produttrici conservano i beni appena prodotti (raccolto e manufatti), ancora da scambiare. È da qui che parte la circolazione.

3. **Primo scambio.** I proprietari, che non producono nulla, spendono la rendita comprando prodotti agricoli dalla classe produttiva. Il denaro passa dai proprietari alla classe produttiva (il primo tratto dello zig-zag, pari a 1); in cambio, i beni agricoli vanno ai proprietari.

4. **Secondo scambio.** La classe produttiva, con parte di quell'incasso, acquista manufatti dalla classe sterile. Il denaro attraversa la figura verso destra (½); i manufatti tornano alla classe produttiva.

5. **Terzo scambio.** La classe sterile usa ciò che ha incassato per comprare viveri e materie prime dalla classe produttiva. Il denaro torna a sinistra (¼); i beni vanno alla classe sterile.

6. **Scambi successivi.** La classe produttiva rispende di nuovo verso la sterile (⅛), e così via. Il denaro continua a rimbalzare fra le due classi che *producono*: è questo andirivieni a dare al tracciato la sua forma a **zig-zag**.

7. **Chiusura del ciclo e riproduzione.** Esauriti gli scambi, il denaro torna alla classe produttiva (la freccia tratteggiata che risale sulla sinistra). Questa ha ora recuperato quanto le serve per due cose: reintegrare le proprie anticipazioni (sementi, strumenti, sussistenza dei lavoratori) e versare di nuovo la rendita ai proprietari l'anno successivo. La classe sterile ha ricostituito i propri mezzi; i proprietari hanno consumato la loro rendita. Nessuno resta con un buco e nessuno accumula in eccesso: il sistema si ritrova nelle stesse condizioni di partenza e può **riprodursi identico**, anno dopo anno. A una condizione, però: che le proporzioni fra le spese siano rispettate. Se saltano, la riproduzione si inceppa, ed è il primo germe dell'idea di *crisi*.
