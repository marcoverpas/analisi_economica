...
Con John Maynard Keynes (1883-1946) l'economia ritrova la sua dimensione **macroeconomica**. Formatosi a Cambridge nell'ambiente marshalliano, protagonista dei grandi dibattiti del suo tempo (dalla critica al trattato di Versailles agli accordi di Bretton Woods del 1944), Keynes consegna alla *Teoria generale dell'occupazione, dell'interesse e della moneta* (1936) l'opera che rifonda la disciplina. Il suo oggetto non è più l'allocazione di risorse date da parte di individui isolati, ma la **determinazione del livello del reddito e dell'occupazione** dell'intera economia, e le cause delle sue fluttuazioni. La tesi di fondo è che il mercato, lasciato a se stesso, **non** si autocoordina: la mano invisibile non garantisce alcuna allocazione ottimale, e in particolare non garantisce la piena occupazione, che può mancare anche con prezzi e salari flessibili.

Se il marginalismo aveva sviluppato l'anima "micro" di Smith (sezione 2.1), Keynes riprende e sviluppa la sua anima "macro" - il reddito, la domanda, l'occupazione, la dimensione sociale - fino ad allora coltivata dai classici e da Malthus. Da qui la domanda che dà il titolo alla sezione: la sua fu una **rottura** o un **rinnovamento**? Rottura netta con l'ortodossia neoclassica, di cui rovescia i presupposti; ma anche, per altri versi, il ritorno di una tradizione più antica, quella dell'economia politica attenta alla riproduzione e alla domanda aggregata. Come vedremo, la risposta a questa domanda ha diviso, e continua a dividere, gli eredi di Keynes.
...
Il terzo pilastro neoclassico che Keynes abbatte riguarda la natura del tasso di interesse. Per lui l'interesse **non** è una variabile reale che premia l'astinenza, ma una variabile puramente **monetaria**: è il prezzo che induce a rinunciare alla liquidità. La domanda di moneta risponde a motivi diversi - transattivo, precauzionale, speculativo - ma la funzione decisiva della moneta è quella di **riserva di valore**. In un mondo incerto, detenere moneta, l'attività più liquida, protegge dall'ignoto: è la **preferenza per la liquidità**. "Perché mai qualcuno, fuori da un manicomio, dovrebbe voler usare la moneta come riserva di ricchezza?", si chiede Keynes: perché il possesso di moneta placa la nostra inquietudine di fronte a un futuro che non sappiamo calcolare, e il premio che chiediamo per separarcene misura il grado di quella inquietudine.
