...
- [**1.4** La "critica" di Marx: accumulazione, sfruttamento e crisi](https://github.com/marcoverpas/analisi_economica#14-la-critica-di-marx-accumulazione-sfruttamento-e-crisi)
...
- [**3.3** L'economia come sistema complesso: dinamica, emergenza e agenti interagenti](https://github.com/marcoverpas/analisi_economica/tree/main#33-leconomia-come-sistema-complesso-dinamica-emergenza-e-agenti-interagenti)
...
- [**Box 1** - Il moltiplicatore come serie convergente](#box-1): come il moltiplicatore keynesiano nasca da una serie geometrica e sia, di fatto, l'inversa di Leontief di un'economia con un solo bene (sezione 2.2).
- [**Box 2** - Ripasso lampo: autovalori e autovettori](#box-2): che cosa sono autovalori e autovettori, con l'aiuto di un'animazione (sezione 3.1).
- [**Box 3** - L'invertibilità di (I − A)](#box-3): quando esiste l'inversa di Leontief e perché occorre la "produttività" del sistema (sezione 3.1).
- [**Box 4** - Il teorema di Perron-Frobenius](#box-4): come un solo numero e un solo vettore riassumano il limite tecnologico alla distribuzione del reddito (sezione 3.1).
- [**Box 5** - La merce tipo](#box-5): l'invenzione con cui Sraffa risolve il problema della misura invariabile del valore, e il suo legame con l'autovettore di Perron (sezione 3.1).
...
- **confrontare** l'approccio classico-keynesiano e i suoi sviluppi recenti con il paradigma marginalista-neoclassico, e interpretare il ruolo della moneta e della finanza nel processo di produzione;
...
- **utilizzare** schemi concettuali e semplici strumenti modellistici, inclusi ambienti e linguaggi di programmazione, per rappresentare il funzionamento di un'economia.
...
Ulteriori suggerimenti di lettura saranno dati durante il corso. Una lista completa dei [riferimenti bibliografici](https://github.com/marcoverpas/analisi_economica/blob/main/README.md#riferimenti-bibliografici) è disponibile in fondo a questa pagina. 
...
<table>
<tr><td width="820" align="center">
<img src="https://raw.githubusercontent.com/marcoverpas/figures/main/Equilibrio.png" width="800" alt="I quattro concetti di equilibrio"><br>
<sub><em>Figura 1.2 - I quattro concetti di equilibrio. La pallina rappresenta il sistema economico e il suo punto di quiete il centro di gravità (l'equilibrio). (a) Equilibrio unico e stabile: dopo ogni perturbazione il sistema vi ritorna. (b) Equilibrio neutrale: ogni posizione è di equilibrio e il sistema permane dove lo *shock* lo conduce. (c) Equilibrio instabile: una piccola deviazione tende ad amplificarsi. (d) Equilibri multipli: coesistono più posizioni di equilibrio, e quale si realizzi dipende da condizioni iniziali, storia e aspettative.</em></sub>
</td></tr>
</table>
</div>
...
#### 1.1.4 Il dibattito corrente sulla scientificità
...
<img src="https://raw.githubusercontent.com/marcoverpas/figures/main/Phillips_and_MONIAC_LSE.jpg" width="380"><br>
<sub><em>(a) A. W. H. Phillips accanto al MONIAC.</em></sub>
</td>
<td align="center" width="50%">
<img src="https://raw.githubusercontent.com/marcoverpas/figures/main/moniac_ita.gif" width="380"><br>
<sub><em>(b) Una simulazione del funzionamento del MONIAC.</em></sub>
</td>
</tr>
</table>
...
<table>
<tr><td width="820" align="center">
<img src="https://raw.githubusercontent.com/marcoverpas/figures/main/Tableau.png" width="820" alt="Tableau économique stilizzato"><br>
<sub><em><strong>Figura 1.4</strong> - Il <em>Tableau économique</em> di François Quesnay (1758), in versione stilizzata. Le frecce, numerate in ordine temporale, rappresentano flussi di moneta; in senso opposto viaggiano le merci. Il meccanismo è descritto, passaggio per passaggio, nel testo. Concependo la produzione come processo circolare, e non come catena lineare dai fattori al prodotto, il <em>Tableau</em> è l'antenato diretto degli schemi di riproduzione di Marx, del modello input-output di Leontief e del sistema dei prezzi di Sraffa, cioè della tradizione classica del sovrappiù che percorre questo corso.</em></sub>
</td></tr>
</table>
</div>

La Figura 1.4 mostra l'intero processo di circolazione di denaro e merci nell'arco di un anno. Prima di seguirlo, introduciamo due convenzioni: le **frecce piene** rappresentano **pagamenti in denaro**; in senso opposto, anche se non disegnate, viaggiano le **merci** (dove la freccia porta il denaro in avanti, il bene torna indietro). Seguiamo allora il ciclo passo per passo, dall'inizio della produzione alla fine.

1. **Produzione e rendita (freccia 1).** All'inizio del ciclo gli imprenditori agricoli impiegano le proprie *anticipazioni* (sementi, strumenti e i salari anticipati ai lavoratori) e lavorano la terra; al termine dell'annata ottengono il raccolto. Poiché per i fisiocratici solo l'agricoltura rende più di quanto consuma, in quel prodotto è contenuta un'eccedenza sui costi, il *produit net*, che essi identificavano per intero con la **rendita**: gli imprenditori agricoli la versano ai proprietari terrieri (freccia 1). Poniamo che valga 2 miliardi. Gli artigiani, nel frattempo, hanno trasformato in manufatti le materie prime e i mezzi di sussistenza di cui già disponevano (le proprie *anticipazioni*, accumulate nel ciclo precedente), senza però generare alcuna eccedenza: il valore dei loro prodotti eguaglia quello degli input impiegati.

2. **I proprietari spendono la rendita (frecce 2 e 3).** I proprietari, che non producono, spendono l'intera rendita: **1** per comprare derrate alimentari dagli imprenditori agricoli (freccia 2) e **1** per comprare manufatti dagli artigiani (freccia 3). In cambio del denaro, le merci viaggiano in senso opposto.

3. **Il denaro degli artigiani rifluisce all'agricoltura (freccia 4).** Gli artigiani usano l'incasso (1) per comprare viveri e materie prime dagli imprenditori agricoli (freccia 4): anche quel denaro torna così all'agricoltura, e serve agli artigiani per ricostituire le materie prime e i viveri necessari al ciclo successivo.

4. **Chiusura del ciclo e riproduzione.** Alla fine del giro gli imprenditori agricoli hanno incassato 1 (freccia 2) + 1 (freccia 4) = **2**, esattamente la rendita che avevano versato. I proprietari e gli artigiani restano senza denaro (hanno solo i beni acquistati). Il sistema è tornato nelle condizioni di partenza: gli imprenditori agricoli possono reintegrare le proprie anticipazioni e pagare di nuovo la rendita l'anno successivo, e il ciclo può **riprodursi identico**. A una condizione, però: che le proporzioni fra le spese siano rispettate. Se saltano, la riproduzione si inceppa, ed è il primo germe dell'idea di *crisi*.
...
> 💡 **Lavoro produttivo e improduttivo (I): i fisiocratici.** Riassumendo il criterio appena visto: per i fisiocratici è produttivo **solo il lavoro agricolo**, l'unico capace di restituire un *produit net*; ogni altro lavoro - artigiano, manifatturiero, mercantile - è detto *sterile*, perché si limita a trasformare o a far circolare valori già esistenti, senza aggiungerne di nuovi. In termini odierni sarebbe produttivo il bracciante agricolo, sterile tanto l'operaio di fabbrica quanto il commesso o l'insegnante. Il criterio è dunque **settoriale**: la fonte del sovrappiù è la terra.

#### 1.2.2 Smith e le tre teorie del valore
...
> 💡 **Lavoro produttivo e improduttivo (II): Smith.** Smith rovescia il criterio settoriale. Produttivo è per lui il lavoro che si **fissa in una merce materiale**, durevole e vendibile, e che, impiegato dal capitale, ne reintegra il valore lasciando un profitto; improduttivo è il lavoro che si consuma nell'atto stesso in cui è prestato, senza lasciare un oggetto scambiabile. Diventa così produttivo non solo il contadino ma anche l'operaio manifatturiero (il «colletto blu»), mentre restano improduttivi i servizi personali: il domestico, ma anche - nell'elenco di Smith - il sovrano e i suoi funzionari, l'esercito, i giudici, i medici, gli avvocati, i musicisti. Un insegnante o un cuoco, in questa lettura, sono improduttivi perché il loro lavoro non si incorpora in alcun bene rivendibile. Il criterio è **materiale**.
...
Indichiamo con $L_i$ il lavoro complessivamente impiegato nel settore $i$ e con $l_i = L_i/x_i$ il lavoro per unità di prodotto, con $w$ il salario monetario uniforme e con $r_i$ il saggio di profitto (per il momento anche diverso da settore a settore).

Il *valore* complessivo delle merci, inteso come lavoro contenuto, è definito da $\lambda_i x_i = L_i$. Il valore della singola merce è dunque:

$$\lambda_i = \frac{L_i}{x_i} = l_i \qquad (1.1)$$
...
$$p_i = w l_i + w l_i r_i = w l_i (1 + r_i) \qquad (1.2)$$

Il prezzo espresso in **lavoro comandato**, $l_i^{c}$, è allora:

$$\frac{p_i}{w} = l_i (1 + r_i) \equiv l_i^{c} \qquad (1.3)$$

Il confronto con il lavoro contenuto è immediato:

$$l_i^{c} = l_i (1 + r_i) > l_i = \lambda_i \qquad (1.4)$$

Il **lavoro comandato eccede il lavoro contenuto** se e solo se $r_i > 0$, cioè esattamente in ragione del profitto. Ciò definisce la struttura dei prezzi relativi. Per due merci qualsiasi - 1 e 2 - si ha, infatti, che:

$$\frac{p_1}{p_2} = \frac{w l_1 (1 + r_1)}{w l_2 (1 + r_2)} = \frac{l_1 (1 + r_1)}{l_2 (1 + r_2)} \qquad (1.5)$$
...
Se è lecito scrivere il prezzo come somma dei redditi, è invece un errore leggere quei redditi come *fonti prime* del valore. Se salari e profitti fossero determinati in modo indipendente, la relazione fisserebbe simultaneamente il salario e il saggio di profitto, e il sistema risulterebbe sovradeterminato. Coerenza richiede che il profitto sia un *residuo*. Omettendo i pedici, dato il salario reale $\omega \equiv w/p$, dall'equazione del prezzo (1.2) si ricava:

$$r = \frac{1}{\omega l} - 1 = \frac{1 - \omega l}{\omega l} \qquad (1.7)$$

Il **saggio di profitto** è così determinato per differenza, una volta dato il salario reale, secondo la relazione inversa fra salario e profitto che sarà il cuore dell'analisi ricardiana della distribuzione. Si intravede già, del resto, il nesso con lo sfruttamento: data la tecnologia, un'unità di lavoro produce $1/l$ unità di merce, ma il lavoratore ne riceve soltanto $\omega < 1/l$ (è la condizione $\omega l<1$, cioè $r>0$), e la differenza è il sovrappiù che si trasforma in profitto. Si tratta, per ora, di una semplice intuizione. La sua formulazione rigorosa richiederà la distinzione, propria di Marx, fra il lavoro e la forza-lavoro, il cui valore è inferiore al valore che essa è in grado di creare.

> [!NOTE]
> 💡 **Le tre teorie dei prezzi di Smith.** Le tre impostazioni di Smith si lasciano riassumere così: il valore come *lavoro contenuto*, $\lambda_i = l_i$; la misura del valore come *lavoro comandato*, $l_i^{c}=l_i(1+r_i)$; la scomposizione *additiva* del prezzo, $p_i x_i = V_i + \Pi_i$. Le prime due misure coincidono solo se $r_i=0$; la terza è legittima come contabilità del valore, ma fallace se interpreta i redditi come sue fonti prime.
...
dove $L$ è il lavoro impiegato e $a = a(L)$ il prodotto (netto) per lavoratore, decrescente ($a'(L) < 0$). Il saggio di profitto agricolo sulla terra marginale, dove non si paga rendita, è allora:

$$r = \frac{X - wL}{wL} = \frac{a}{w} - 1 \qquad (1.9)$$

con $w$ il salario (in grano) per lavoratore. La (1.9) esprime, in forma trasparente, la **relazione inversa fra saggio di profitto e salario**: se $w$ è fisso al livello di sussistenza, $r$ è determinato per residuo e si riduce all'aumentare di $L$, cioè al decrescere di $a$.
...
### 1.4 La "critica" di Marx: accumulazione, sfruttamento e crisi
...
Si vende una merce ($M$) per denaro ($D$) allo scopo di acquistarne un'altra. Qui il denaro è mero mezzo di scambio tra due merci dotate di diversi valori d'uso e il fine è il *consumo*.

La seconda è la **circolazione propriamente capitalistica**:

$$D - M - D' \qquad (1.15)$$

con $\Delta D = D' - D$. Si anticipa denaro per acquistare merci e rivenderle a una somma maggiore. Ora il denaro non è più un lubrificante degli scambi, ma **capitale**: il fine non è il consumo, bensì la *valorizzazione*, cioè il profitto e l'accumulazione. Sorge, però, un problema. Se sul mercato si scambiano equivalenti, da dove nasce l'eccedenza $\Delta D$?
...
> 💡 **Lavoro produttivo e improduttivo (III): Marx.** Marx abbandona il criterio della materialità e ne fa una questione di **rapporto sociale**: è produttivo il lavoro che **produce plusvalore per il capitale**, cioè quello scambiato contro capitale nella relazione salariale, quale che sia la natura concreta del suo prodotto. Ne segue un ribaltamento istruttivo: lo *stesso* lavoro è produttivo o improduttivo a seconda di *come* è impiegato. Un insegnante assunto da una scuola privata gestita a scopo di lucro è lavoratore produttivo (valorizza il capitale del proprietario), mentre l'identico insegnamento svolto da un libero professionista o da un dipendente pubblico non lo è; il cuoco di un ristorante capitalistico è produttivo, il cuoco privato di una famiglia benestante no. Non conta se il prodotto sia un bene o un servizio, ma se il lavoro valorizzi o meno un capitale.
...
con $q$ la composizione organica dell'intera economia. Il saggio di profitto cresce con lo sfruttamento $\sigma$ e diminuisce con la composizione organica $q$ (relazione da cui deriva la tendenza alla caduta del saggio di profitto).
...
dove $(I-A)^{-1}$ è la **matrice inversa di Leontief** (che discuteremo in dettaglio più avanti). I prezzi di produzione (vettore riga $p$), valutando gli input al loro prezzo effettivo e anticipando il salario monetario $w$, risolvono a loro volta:

$$p = (1+r) (p A + w l) \qquad (1.23)$$

Questo, come vedremo, ha essenzialmente la stessa struttura del sistema di prezzi che Piero Sraffa ricaverà nel 1960 (sezione 2.3) - a meno della convenzione sul salario - fondato sull'inversa di Leontief del modello input-output (sezione 3.1).
...
<p align="center"><sub><em>Figura 1.8 - Schemi di riproduzione: effetto di una caduta della propensione all'accumulo del settore 1 sui saggi di accumulazione (a sinistra) e sulle propensioni all'accumulo (a destra).</em></sub></p>
...
#### 2.1.2 Le ragioni interne: i nodi irrisolti di Ricardo
...
#### 2.1.3 Le ragioni esterne: il clima politico e il valore-lavoro dei socialisti
...
#### 2.1.4 Metodo, ortodossia e la crisi rimossa
...
#### 2.2.1 Dal *Trattato sulla moneta* alla *Teoria generale*
...
#### 2.2.2 Le tre critiche alla base della rivoluzione keynesiana
...
$$\Delta Y = \frac{1}{1 - c_1} \Delta(c_0 + I + G) \qquad (2.1)$$
...
<a id="box-1"></a>
> [!NOTE]
> 🤓🧠🔢 **Box per geek e nerd 1 - Il moltiplicatore come serie convergente (e altre curiosità).** Dietro il moltiplicatore keynesiano si nasconde una delle serie più celebri della matematica, la **serie geometrica**. Si immagini un'iniezione iniziale di spesa autonoma pari a $\Delta A$ (più investimenti, o più spesa pubblica). Quell'importo diventa reddito per qualcuno, che ne rispende una frazione $c_1$ (la propensione marginale al consumo). Quella spesa diventa reddito per un altro, che ne rispende $c_1$, e così via. La somma di tutti i "giri" è $\Delta A \cdot (1 + c_1 + c_1^2 + c_1^3 + \cdots)$. Poiché $0 < c_1 < 1$, la serie converge a $\Delta A/(1-c_1)$, e $1/(1-c_1)$ è il **moltiplicatore**. La condizione $c_1 < 1$ non è un dettaglio tecnico: se ogni euro fosse interamente rispeso ($c_1 = 1$) la serie divergerebbe e il sistema non avrebbe un reddito di equilibrio finito. **Il moltiplicatore è un'inversa di Leontief scalare.** La formula $1/(1-c_1) = 1 + c_1 + c_1^2 + \cdots$ è il caso a una dimensione della **serie di Neumann** $(I-A)^{-1} = I + A + A^2 + \cdots$ che governa il modello input-output (sezione 3.1) e il sistema di Sraffa (si vedano i box 3 e 4). Là la condizione di convergenza era il raggio spettrale minore di 1. Qui è semplicemente $c_1 < 1$. Il moltiplicatore, insomma, è l'inversa di Leontief di un'economia con un solo bene: la stessa matematica, vista da un solo lato. **La stessa serie governa anche il tempo.** Nel modello dinamico $Y_t = c_0 + c_1 Y_{t-1} + I_0$, l'aumento del reddito dopo un incremento permanente $\Delta I$ non arriva tutto in un colpo: cresce periodo dopo periodo seguendo le **somme parziali** della stessa serie - prima $\Delta I$, poi $\Delta I(1 + c_1)$, poi $\Delta I(1 + c_1 + c_1^2)$, e così via - fino al totale $\Delta I/(1-c_1)$. La serie che prima sommavamo "per giri di spesa" ricompare ora "per periodi". Questa è la ragione per cui nel primo modello discusso nella sezione 2.2.6 il reddito converge al nuovo livello in modo geometrico. Lo scarto residuo dallo stato stazionario si riduce di un fattore $c_1$ a ogni periodo, con un tempo di dimezzamento pari a $\ln(1/2)/\ln(c_1)$: per $c_1 = 0.8$, circa tre periodi. **Con le "perdite", il moltiplicatore si accorcia.** Se una parte del reddito sfugge al circuito interno (risparmio, imposte, importazioni) la propensione a rispendere diminuisce, e con essa il moltiplicatore. Introducendo un'aliquota $\theta$, per esempio, il consumo dipende dal reddito al netto delle imposte e il moltiplicatore diventa $1/(1 - c_1(1-\theta))$. È lo stesso motivo per cui, nel secondo modello della sezione 2.2.6 il reddito di stato stazionario non è $1/(1-c_1)$ volte la spesa, bensì $G/\theta$. Nel lungo periodo, quando il risparmio netto si annulla, l'unica "perdita" che conta è quella fiscale, e il moltiplicatore di lungo periodo della spesa pubblica è $1/\theta$. Un'ultima curiosità: la serie $1 + c_1 + c_1^2 + \cdots$ appartiene alla stessa famiglia che "risolve" il paradosso di Zenone di Achille e la tartaruga - infiniti passi la cui somma è un totale finito.

#### 2.2.3 Preferenza per la liquidità, moneta e crisi
...
#### 2.2.4 Politica economica e i limiti del *laissez-faire*
...
#### 2.2.5 La sintesi neoclassica, il modello IS-LM e i suoi limiti
...
$$I = a_k \cdot \Delta Y \qquad (2.3)$$

dove $a_k > 1$ è il rapporto marginale capitale/prodotto ($a_k = \Delta K / \Delta Y$). Imponendo $S = I$ si ottiene $s \cdot Y = a_k \cdot \Delta Y$, da cui:

$$G \equiv \frac{\Delta Y}{Y} = \frac{s}{a_k} \qquad (2.4)$$
...
<table align="center">
  ...
  <tr><td width="620" align="center">
    <em><strong>Figura 2.3</strong> - Modello di Harrod-Domar (moltiplicatore + acceleratore). Con aspettative confermate il reddito cresce al saggio garantito <em>G</em> (linea arancione). Un errore di aspettativa una tantum (periodo 20) sposta l'economia su una traiettoria più alta (domanda effettiva &gt; attesa) o più bassa (domanda effettiva &lt; attesa) e non viene mai riassorbito: lo scarto dal sentiero garantito (pannello b) si allarga nel tempo. Il sentiero garantito non è un attrattore: è l'instabilità "sul filo del rasoio", che motiva l'intervento pubblico. Parametri: <em>s</em> = 0.2 e <em>a</em> = 4; con la temporizzazione discreta del codice il saggio garantito è <em>s</em>/(<em>a</em>&thinsp;&minus;&thinsp;<em>s</em>) &asymp; 0.053, che nel limite continuo coincide con <em>G</em> = <em>s</em>/<em>a</em> = 0.05.</em>
  </td></tr>
</table>
...
dove $a_{ij}$ è la quantità di merce $i$ necessaria per una unità di merce $j$ (ricavabile dall'esempio: $a_{gg}=280/400=0.7$, $a_{fg}=12/400=0.03$, $a_{gf}=120/20=6$, $a_{ff}=8/20=0.4$), mentre $l_g$ e $l_f$ sono i coefficienti di lavoro diretto. Le due equazioni hanno la stessa struttura: *costo dei mezzi di produzione* $\times (1+r)$, più il *salario*.

Passando da due a $n$ merci, le equazioni diventano $n$: la coppia dei prezzi $(p_g, p_f)$ diventa un vettore riga $p$, i coefficienti $a_{ij}$ una **matrice** $A$ (la cui colonna $j$ raccoglie gli input necessari a produrre il bene $j$), i coefficienti di lavoro un vettore $l$. In forma compatta si ottiene il sistema dei **prezzi di produzione** di Sraffa:
...
$$P = \frac{M \cdot V}{Y} \qquad (2.13)$$

con la velocità di circolazione $V$ trattata come stabile e il reddito reale $Y$ ancorato al suo livello "naturale".

L'offerta di moneta, a sua volta, viene concepita come una grandezza che la banca centrale controlla dall'esterno attraverso la base monetaria $H$ e il **moltiplicatore della moneta**:

$$M = m \cdot H \qquad (2.14)$$

dove $m$ dipende dalle propensioni a detenere circolante e riserve. Si tratta della visione *esogena* della moneta, ribaltata rispetto alla logica keynesiana: la quantità di moneta non risponde ai bisogni della produzione, ma è la variabile di controllo da cui dipendono i prezzi.

La conseguenza polemica è immediata: se lo Stato finanzia la spesa emettendo moneta, non fa che alimentare l'inflazione. La politica fiscale espansiva viene così ridefinita, per costruzione, come un fenomeno essenzialmente **inflazionistico**. Per una critica di questa impostazione, si veda [qui](https://github.com/marcoverpas/economia_monetaria#9-implicazioni-della-moneta-endogena).
...
$$\pi = \pi^{e} - \alpha \cdot (u - u_n) \qquad (2.16)$$

dove $\pi^{e}$ è l'inflazione attesa e $u_n$ il tasso di disoccupazione "naturale". Se le aspettative sono *adattive* - se cioè i lavoratori aggiornano gradualmente $\pi^{e}$ sulla base dell'inflazione passata - allora esiste un *trade-off* fra inflazione e disoccupazione solo *finché* gli agenti sono ingannati. Nel **lungo periodo**, quando le aspettative si adeguano ($\pi^{e} = \pi$), la disoccupazione ritorna al livello naturale e la curva di Phillips diventa **verticale** ($u=u_n$). Nessuna politica della domanda può, quindi, tenere stabilmente la disoccupazione al di sotto di $u_n$, ma solo accelerare l'inflazione. La disoccupazione, di nuovo, dipende soltanto da fattori "reali" (l'offerta di lavoro, le imperfezioni del mercato del lavoro), esattamente come nella teoria pre-keynesiana.
...
<table align="center">
  ...
  <tr><td width="820" align="center">
        <em><strong>Figura 2.6</strong> - Alcuni tra i maggiori protagonisti dei dibattiti su teoria e metodi per lo studio dei fenomeni economici, disposti in una griglia 2&times;3. Vi compaiono <strong>Adam Smith</strong>, fondatore dell'economia politica e delle sue "due anime", micro e macro (sezione 1.2); <strong>David Ricardo</strong>, che pone al centro la distribuzione del prodotto fra le classi e il conflitto che l'accompagna (sezione 1.3); <strong>Karl Marx</strong>, che trasforma l'economia politica classica in <em>critica</em> dell'economia politica, con la teoria dello sfruttamento e delle crisi endogene (sezione 1.4); <strong>John Maynard Keynes</strong>, che restituisce all'analisi la dimensione macroeconomica e il principio della domanda effettiva (sezione 2.2); <strong>Milton Friedman</strong>, principale artefice della controrivoluzione monetarista (sezione 2.4); e <strong>Piero Sraffa</strong>, che ricostruisce l'impianto classico del sovrappiù e ne fornisce la veste matematica moderna, ponte verso il modello input-output (sezione 2.3). Le loro posizioni, spesso in aperto contrasto, incarnano le due visioni di base - il mercato come ordine autoregolato contro la centralità della produzione e del conflitto - attorno a cui ruota l'intero corso (Figura 1.1).</em>
  </td></tr>
</table>
...
La matrice $(I - A)^{-1}$ è l'**inversa di Leontief**, che abbiamo già incontrato più volte. Essa traduce una qualunque domanda finale $d$ nella produzione lorda che ogni industria deve realizzare per soddisfarla, **direttamente e indirettamente**. Il significato diventa trasparente sviluppando l'inversa nella **serie di Neumann** $(I - A)^{-1} = I + A + A^2 + A^3 + \cdots$ (si vedano i box per geek e nerd 1 e 3).

La produzione deve coprire la domanda finale ($I$), poi gli input necessari a produrla ($A$), poi gli input di quegli input ($A^2$), lungo una catena infinita che converge purché il sistema sia **produttivo**, cioè capace di reintegrare i propri mezzi di produzione e lasciare un sovrappiù. Le condizioni precise di esistenza e di positività dell'inversa - il raggio spettrale di $A$ minore di 1 e il teorema di Perron-Frobenius - sono discusse nei box 3 e 4.
...
Il pannello (c) mostra da dove nasce tutto questo: la produzione lorda non si determina in un colpo solo, ma come somma di "giri" successivi di domanda intermedia, la serie di Neumann $I + A + A^2 + \cdots$, che converge perché ogni giro pesa meno del precedente (il raggio spettrale è $0.47$). È la stessa logica del moltiplicatore keynesiano (Box 1), qui applicata a una rete di industrie anziché a un solo bene.
...
<a id="box-3"></a>
> [!NOTE]
> 🤓🧠🔢 **Box per geek e nerd 3 - L'invertibilità di (I − A).** Partiamo dalla domanda: **quando esiste l'inversa di Leontief?** Il sistema di Sraffa, come quello di Leontief, ruota attorno alla matrice $(I-A)^{-1}$, dove $A$ è la matrice dei coefficienti tecnici ($a_{ij}$ è la quantità del bene $i$ necessaria per produrre una unità del bene $j$). Sul piano puramente algebrico l'inversa esiste quando il **determinante** non si annulla, $\det(I-A) \neq 0$. Poiché $\det(I-A) = \prod_i (1 - \lambda_i)$, con $\lambda_i$ autovalori di $A$, ciò equivale a chiedere che 1 non sia un autovalore di $A$ (nota: un autovalore pari a 1 significa che esiste una configurazione produttiva tale che gli input richiesti eguagliano esattamente gli output). All'economia, però, serve qualcosa di più. L'inversa ha infatti un significato preciso: sviluppata in serie, $(I-A)^{-1} = I + A + A^2 + A^3 + \cdots$, somma i fabbisogni diretti ($A$), poi gli input degli input ($A^2$), poi gli input degli input degli input ($A^3$), lungo una catena infinita. Perché questa somma converga a una matrice finita e **non negativa** non basta $\det(I-A) \neq 0$. Occorre che ogni "giro" della catena pesi meno del precedente, cioè che il **raggio spettrale** di $A$ (l'autovalore dominante $\lambda_{\max}$) sia minore di 1. È la condizione di **produttività**, equivalente (teorema di Hawkins-Simon) alla positività di tutti i minori principali di testa di $(I-A)$, a partire dallo stesso determinante. Il sistema deve poter reintegrare i propri mezzi di produzione e lasciare un **sovrappiù**. Se $\lambda_{\max} \geq 1$ la catena non converge, $(I-A)^{-1}$ non esiste come matrice economicamente sensata, e il sistema non riesce nemmeno a riprodursi.
...
<a id="box-5"></a>
> [!NOTE]
> 🤓🧠🔢 **Box per geek e nerd 5 - La merce tipo.** Al variare della distribuzione i prezzi relativi cambiano, e sembra impossibile trovare un'unità di misura del valore "invariabile" rispetto a $r$: è il problema che aveva sconfitto Ricardo (sezione 1.3.4). Sraffa lo risolve con un'invenzione ingegnosa, la **merce tipo** (*Standard commodity*). Si tratta di una merce *composita*, un paniere costruito in modo che entri nella propria produzione nelle **stesse proporzioni** in cui ne esce come prodotto. Nel sistema che la produce (il "sistema tipo") il rapporto fra prodotto netto e mezzi di produzione, il **rapporto tipo** $R$, è allora lo stesso in ogni industria e **non dipende dai prezzi**. Adottando la merce tipo come numerario, la relazione salario-profitto diventa **lineare**: $r = R \cdot (1 - w)$, dove $w$ è la quota di salario sul prodotto netto tipo e $R$ è il **saggio massimo del profitto**, quello che si otterrebbe con salario nullo. Ecco l'unità di misura invariabile che Ricardo cercava. E qui scatta il legame con i box precedenti: la merce tipo è, in sostanza, l'**autovettore di Perron** della matrice dei coefficienti tecnici (le "proporzioni stabili" del sistema, la direzione che la tecnologia non altera), e il rapporto tipo coincide con l'autovalore dominante trasformato, $R = 1/\lambda_{\max} - 1$ - esattamente il saggio massimo del profitto ricavato nel box su Perron-Frobenius. La stessa matematica che governa l'invertibilità di $(I-A)$ e la riproduzione del sistema fornisce dunque, con la merce tipo, la chiave per districare distribuzione e prezzi.
...
Data un'economia chiusa e senza intervento pubblico (dove $Y=C+I$), basta ora ricordare che il profitto d'impresa è il reddito che resta dopo aver pagato salari, interessi e ammortamenti:
...
Il circuito non è un meccanismo neutrale, ma una **relazione triangolare** fra imprese, lavoratori e banche che incorpora una precisa **divisione in classi** (Veronese Passarella, 2024). Solo chi ha accesso al credito bancario - le imprese, i capitalisti - può *avviare* il circuito acquistando forza-lavoro; i lavoratori possono soltanto venderla, e ricevono moneta solo alla fine. Questa asimmetria strutturale è la forma monetaria del rapporto di classe e dello sfruttamento analizzati in Marx (sezione 1.4.3), e riecheggia l'idea sraffiana di una distribuzione fissata **dall'esterno** del sistema dei prezzi (sezione 2.3.3). In questo senso, il circuito è una declinazione marxiana del metodo degli aggregati di Keynes: la circolazione capitalistica $D-M-D'$ (sezione 1.4.2) letta con gli strumenti della domanda effettiva.
...
La regola che tiene insieme il tutto è semplice e stringente: ogni **attività finanziaria è la passività di qualcun altro**, sicché ogni riga finanziaria somma a zero. L'unica eccezione sono il capitale fisso $K$ e gli immobili, attività **reali** che non hanno contropartita e costituiscono la ricchezza netta dell'intero sistema. Letta per colonne, la matrice dà la ricchezza netta di ciascun settore.
...
dove $\alpha_1$ è la propensione marginale al consumo del reddito e $\alpha_2$ quella al consumo della ricchezza. L'equazione ridondante (nascosta) eguaglia la moneta domandata e quella offerta, $H_h = H_s$.
...
Il reddito verso cui l'economia converge nel tempo è, dunque, la spesa pubblica moltiplicata per $1/\theta$: è il moltiplicatore keynesiano (Box 1), qui in versione fondi-flussi, dove l'unica "perdita" dal circuito del reddito è quella fiscale.
...
Il punto cruciale è la (3.30): **ogni prestito crea un deposito** ($\Delta M = \Delta L$). Le (3.32)-(3.33) sono l'**acceleratore**: le imprese puntano a raggiungere e mantenere uno *stock* di capitale fisso proporzionale al prodotto ritardato e ne colmano ogni periodo una frazione $\gamma$, oltre a sostituire il capitale logorato. L'equazione ridondante è $M_h = M_s$.
...
ossia è pari alla somma di consumo e spesa pubblica (mentre nella versione con investimenti compare in più il termine $B_i \cdot i$). L'inversa di Leontief converte la domanda finale in produzione lorda:
...
$$p = w \cdot l + (1 + \mu) \cdot p A \qquad (3.39)$$
...
$$p_c = p B_c, \qquad p_g = p B_g \qquad (3.41)$$
...
dove $\pi=\Delta p_c/p_c$ è il tasso d'inflazione. Poiché ora i prezzi **esistono**, grandezze reali e nominali divergono: il consumo è scelto in termini reali, ma il prodotto è misurato in valore.
...
### 3.3 L'economia come sistema complesso: dinamica, emergenza e agenti interagenti
...
Ridotta all'osso, la dinamica minskyana può essere formalizzata tramite un sistema a due variabili, i **profitti** $\Pi$ e il **debito** $D$ delle imprese (Veronese Passarella, 2027b):

$$\dot{\Pi} = (g - a \cdot D) \cdot \Pi \qquad (3.47)$$

$$\dot{D} = (c \cdot \Pi - h) \cdot D \qquad (3.48)$$

In assenza di debito i profitti crescerebbero al ritmo dell'investimento $g$, ma il servizio di un debito crescente li erode ($-a \cdot D$). In assenza di profitti il debito si ridurrebbe al ritmo $h$, ma profitti elevati consentono e incoraggiano nuovo indebitamento ($+c \cdot \Pi$). È un sistema **preda-predatore** (Lotka-Volterra), con i profitti nel ruolo della preda e il debito in quello del predatore: profitti alti alimentano il debito, il debito comprime i profitti, i profitti in caduta costringono a ridurre il debito, e da lì i profitti riprendono - un'orbita perpetua attorno all'equilibrio, non un punto di quiete.

È, si noti, lo **stesso identico modello formale** introdotto per la prima volta in economia da Richard Goodwin (1967) per il ciclo di crescita fondato sul conflitto di classe, e che abbiamo già incontrato nella Parte I discutendo la dinamica del **salario di sussistenza**. La [Figura 1.7](https://github.com/marcoverpas/analisi_economica/tree/main#132-il-modello-grano-grano) che ne rappresentava le oscillazioni e l'orbita nel piano delle fasi è, formalmente, la stessa che descrive qui il ciclo profitti-debito (con il debito al posto della popolazione e il profitto d'impresa al posto del salario reale).
