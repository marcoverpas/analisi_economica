...
Con Adam Smith e la *Ricchezza delle nazioni* (1776) l'economia politica classica assume forma sistematica. Smith, come i classici che lo seguiranno, cerca di spiegare il valore delle merci indipendentemente dalle oscillazioni del mercato: il valore ha per lui uno statuto oggettivo, definito dalle condizioni, ossia dai costi, della produzione. Di qui la distinzione fra *valore d'uso*, l'utilità di un bene, e *valore di scambio*, il suo potere di scambiarsi con altre merci, espresso dai prezzi relativi. Il celebre paradosso dell'acqua e dei diamanti (l'acqua, utilissima, non ha valore di scambio; i diamanti, di scarsa utilità, ne hanno moltissimo) viene da Smith più *dissolto* che risolto: egli recide il legame fra valore d'uso e valore di scambio e ancora quest'ultimo al costo di produzione. La sua vera risoluzione, per mezzo dell'utilità marginale, sarà opera dei marginalisti.
